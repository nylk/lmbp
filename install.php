		...
		<div class="container">
			<div class="header" style="margin:15px auto;">
				<ul class="nav nav-pills pull-right" role="tablist">
					...
					<li role="presentation"><a href="http://bozz.ankk.pw">官网</a></li>
					<li role="presentation"><a href="http://bozz.ankk.pw">访问论坛</a></li>
				</ul>
				<img src="?res=logo" />
			</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						...
						<label class="radio-inline">
							<input type="radio" name="type" value="local"{$insTypes['local']}{$disabled}> 淘宝店铺：波子先森
						</label>
