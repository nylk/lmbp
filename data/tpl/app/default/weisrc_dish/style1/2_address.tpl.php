...
<div id="wrap">
    <div class="page-curruet" style="display: block;">
        <header class="bar bar-nav">
            <a class="button button-link button-nav pull-left" href="<?php  echo $backurl;?>">
                <span class="icon-left"></span>
            </a>
            <a class="button button-link button-nav pull-right" href="<?php  echo $addurl;?>">新增</a>
        ...
        <div class="content">
                ...
                <ul>
                    ...
                    <li class="item-content item-link">
                        <div class="item-inner">
                            <div class="address-list-info" <?php  if($mode!=0) { ?>onclick="setdefault(<?php  echo $row['id'];?>);"<?php  } ?>>
                                <p><?php  echo $row['address'];?> <?php  echo $row['doorplate'];?>
                                    <?php  if($row['isdefault']==1) { ?>
                                    [默认]
                                    <?php  } ?>
                                </p>
                                <p><?php  echo $row['realname'];?> <?php  echo $row['mobile'];?></p>
                            </div>
            ...
            <div class="empty-list" style="display: block;">
                ...
                <p class="empty-list-tip">
                    <a class="button button-fill empty-list-button" href="<?php  echo $addurl;?>">
                        添加一个
                    </a>
                </p>
            </div>
    ...
    <div id="address-list-editor" class="popup" style="<?php  if($operation == 'post') { ?>display:block;top:0px;<?php  } else { ?>display:none;<?php  } ?>">
        <header class="bar bar-nav">
        ...
        <div class="content native-scroll">
            <div class="list-block address-editor">
                ...
                <input type="hidden" name="lat" id="lat" value="<?php  echo $item['lat'];?>">
                <input type="hidden" name="lng" id="lng" value="<?php  echo $item['lng'];?>">
                <ul class="full-width-form">
                    <li class="item-content">
                        <div class="item-inner">
                            ...
                            <div class="item-input input-address" style="padding-right:30px; line-height:21px" >
                                <input type="text" id="mapaddress" name="mapaddress" value="<?php  echo $item['address'];?>"/>
                            </div>
                        ...
                        <div class="item-inner">
                            ...
                            <div class="item-input">
                                <input type="text" placeholder="楼层/门牌号等信息" id="doorplate" name="doorplate"
                                       value="<?php  echo $item['doorplate'];?>"></div>
                        </div>
                    </li>
                    <li class="item-content">
                        <div class="item-inner">
                            ...
                            <div class="item-input">
                                <input type="text" placeholder="您的姓名" id="realname" name="realname" value="<?php  echo $item['realname'];?>">
                            </div>
                        </div>
                    </li>
                    <!--<li class="item-content">-->
                    ...
                    <li class="item-content">
                        <div class="item-inner">
                            ...
                            <div class="item-input">
                                <input type="tel" maxlength="13" placeholder="配送员联系您的方式" value="<?php  echo $item['mobile'];?>"
                                       id="mobile"
                                       name="mobile">
                            </div>
                        </div>
...
//                $('#mapaddress').val(address).blur();
        ...
        $(document).ready(function(){
            ...
            var locationy = 0;
            "<?php  } else { ?>"
            var locationx = "<?php  echo $item['lat'];?>";
            var locationy = "<?php  echo $item['lng'];?>";
            "<?php  } ?>"
