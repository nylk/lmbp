...
//        var_dump($order['dining_mode']);
//        var_dump($is_credit);exit;
...
//        $from_user = $_W['fans']['openid'];
        ...
        //如果有unionid则用unionid做为用户唯一标识
//        if(!empty($userinfo['unionid'])){
//            $from_user = $userinfo['unionid'];
...
//        }
        ...
        setcookie($this->_auth2_unionid, $userinfo['unionid'], time() + 3600 * 24);
//        print_r($userinfo);
//        exit;
        return $userinfo;
    }
