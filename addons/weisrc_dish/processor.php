...
//            mc_update($curopenid, array('nickname' => $mc['nickname'], 'avatar' => $mc['avatar'], 'gender' => $mc['gender']));
//            $mc = mc_fetch($curopenid);
            $tip = '。。。';
        }
//        load()->classs('account');
...
//        $mc = mc_fetch($curopenid);
//        $tip = '。。。';
//        file_put_contents(IA_ROOT . "/addons/weisrc_dish/processor.log", var_export($userinfo, true). PHP_EOL, FILE_APPEND);
